                ...
                stripe.createCardToken(
                        ...
                        new ApiResultCallback<Token>() {
                            public void onSuccess(@NonNull Token token) {
                                ...
                                JSONArray cartJo= new JSONArray();
                                try {
                                    ...
                                    for (int i = 0; i < courseItems.size() ; i++) {
                                        ...
                                        js.put("_id", courseItems.get(i).getID());
                                        js.put("price", courseItems.get(i).getPrice());
                                        js.put("discount", courseItems.get(i).getDiscount());
                                        cartJo.put(js);
                                    }

                                    SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                                    sendJO.put("token", tokenJo);
                                    sendJO.put("cart", cartJo);
